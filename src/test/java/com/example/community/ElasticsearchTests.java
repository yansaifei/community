...
public class ElasticsearchTests {
    ...
    public void testSearchByRepository() {
        ...
        Page<DiscussPost> page = discussRepository.findAll(searchQuery.getPageable());
    ...
    public void testSearchByTemplate() {
        NativeSearchQuery searchQuery = new NativeSearchQueryBuilder()
                ...
                .withPageable(PageRequest.of(0, 10))
                .withHighlightFields(
                        new HighlightBuilder.Field("title").preTags("<em>").postTags("</em>").requireFieldMatch(false),
                        new HighlightBuilder.Field("content").preTags("<em>").postTags("</em>").requireFieldMatch(false)
                ).build();
        ...
        List<DiscussPostRepository> discussPostList = new ArrayList<>();
